...
/// Seeds the database with demo/test data.
///
/// Creates:
...
Future<void> runSeed(Session connection) async {
  ...
  final announcements = [
    {
      ...
      'body': 'Welcome all residents to the new semester. Please ensure your '
    ...
    },
    {
      ...
      'body': 'There will be a scheduled water supply interruption on 15 March '
    ...
    },
    {
      ...
      'body': 'Registration for the annual KIZ Sports Day is now open. Events '
    ...
    },
    {
      ...
      'body': 'The campus WiFi infrastructure will be upgraded next week. '
