...
/// like a stamped ledger entry. Used wherever a status needs to sit inline
/// with text (table cells, detail-screen headers) rather than as a card
/// edge — see [KizCard]'s `spineKind` for the card-list equivalent.
